...
public class UiNotificationRegistryTest {
  ...
  public void testGetInitial() {
    m_registry.put(createMessage(), "topic", null, noTransaction());
    m_registry.put(createMessage(), "topic", null, noTransaction());
    m_registry.put(createMessage(), "topic", null, noTransaction());
  ...
  public void testGetWithLastNotification() {
    ...
    m_registry.put(createMessage("a"), "topic", noTransaction());
    UiNotificationDo notification2 = getNewestNotification("topic");

    m_registry.put(createMessage("b"), "topic", noTransaction());
    UiNotificationDo notification3 = getNewestNotification("topic");
  ...
  public void testGetMultipleTopicsWithLastNotifications() {
    ...
    m_registry.put(createMessage("a"), "topic a", noTransaction()); // 2
    m_registry.put(createMessage("b"), "topic b", noTransaction()); // 3
  ...
  public void testGetWithLastNotificationAndUser() {
    m_registry.put(createMessage(), "topic a", "otto", noTransaction()); // 1
    m_registry.put(createMessage(), "topic a", "max", noTransaction()); // 2
    m_registry.put(createMessage(), "topic a", null, noTransaction()); // 3
    ...
    m_registry.put(createMessage("a new"), "topic a", noTransaction()); // 4
    UiNotificationDo notification4 = getNewestNotification("topic a");

    m_registry.put(createMessage("a new user"), "topic a", "otto", noTransaction()); // 5
    UiNotificationDo notification5 = getNewestNotification("topic a");

    m_registry.put(createMessage("a new user max"), "topic a", "max", noTransaction()); // 6
  ...
  public void testTransactional() {
    m_registry.put(createMessage(), "topic");
  ...
  protected TopicDo createGetAllTopic(String topic) {
    return createTopic(topic, new UiNotificationDo().withId("-1").withCreationTime(new Date(0)).withNodeId(m_registry.currentNodeId()));
  }
